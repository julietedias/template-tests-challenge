...
describe("Transfer Statement", () => {
  ...
  it("should be able to create a new statement", async () => {
    const user_sender: ICreateUserDTO = {
      name: "User Test Sender",
      email: "usertestsender@mail.com",
      password: "123"
    }

    const user_receiver: ICreateUserDTO = {
      name: "User Test Receiver",
      email: "usertestreceiver@mail.com",
      password: "1234"
    }
    ...
    const deposit = {
      type: OperationType.DEPOSIT, amount: 10000, description: "Test description"
    }
    ...
    const withdraw = {
      type: OperationType.WITHDRAW, amount: 500, description: "Rent"
    }
